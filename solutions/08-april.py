...
# Inserting an item at a given position. 'Use .insert'
...
# Removing an item from the list. 'Use .remove'
...
# Returns the number of times an element appears in a list. 'Use .count'
...
print(mens_outfit)
mens_outfit = ['trouser', 'shirt', 'polo', 'shorts', 'tie', 'polo']
print(mens_outfit.count('polo'))

# Sort the items of the list in place. 'Use .sort'
...
# Reverse the elements of a list in place. 'Use .reverse'
...
# Search the lists and find elements. 'Use .index'
